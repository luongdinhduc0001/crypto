...
import re
from adapter import HybridABEncMA
...
class MaabeRW15(ABEncMultiAuth):
    ...
    def __encrypt(self, gp, pks, message, policy_str):
        """
    ...
    def encrypt(self, gp, pks, M, policy_str):
        ...
        k = self.__random_key()
        c1 = self.__encrypt(gp, pks, k, policy_str)
